...
from pamiq_curiosity_exp.models.jepa import Encoder, Predictor
from pamiq_curiosity_exp.utils import size_2d, size_2d_to_int_tuple
...
class JEPATrainer(TorchTrainer):
    ...
    def __init__(
        ...
        context_encoder_name: str = ModelName.IMAGE_JEPA_CONTEXT_ENCODER,
        target_encoder_name: str = ModelName.IMAGE_JEPA_TARGET_ENCODER,
        predictor_name: str = ModelName.IMAGE_JEPA_PREDICTOR,
