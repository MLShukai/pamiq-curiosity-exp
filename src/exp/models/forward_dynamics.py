...
from .components.stacked_hidden_state import StackedHiddenState, StackedLastHiddenState
...
class StackedLastHiddenFD(nn.Module):
    ...
    def __init__(
        ...
        action_info: ActionInfo,
        dim: int,
        core_model: StackedLastHiddenState,
    ) -> None:
        """Initialize the forward dynamics model with last hidden state.
