...
from exp.data.intermittent_buffer import IntermittentBuffer


class TestIntermittentBuffer:
    """Test suite for IntermittentBuffer."""

    @pytest.fixture
    def buffer(self) -> IntermittentBuffer[int]:
        """Fixture providing a standard IntermittentBuffer for tests."""
        return IntermittentBuffer[int](
            max_size=50, get_interval=5, first_add_steps=2, first_store_steps=10
        )

    def test_init(self):
        """Test IntermittentBuffer initialization with various parameters."""
        # Test with standard parameters
        max_size = 50
        buffer = IntermittentBuffer[int](
            max_size, get_interval=5, first_add_steps=2, first_store_steps=10
        )

        assert buffer.max_size == max_size

    def test_add_and_get_data(self, buffer: IntermittentBuffer[int]):
    ...
    def test_get_data_returns_copy(self, buffer: IntermittentBuffer[int]):
    ...
    def test_save_and_load_state(self, buffer: IntermittentBuffer[int], tmp_path: Path):
        ...
        new_buffer = IntermittentBuffer[int](
    ...
    def test_len(self, buffer: IntermittentBuffer[int]):
