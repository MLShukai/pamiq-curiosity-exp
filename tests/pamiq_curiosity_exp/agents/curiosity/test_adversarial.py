...
from pamiq_curiosity_exp.agents.curiosity.adversarial import AdversarialCuriosityAgent
...
class TestAdversarialCuriosityAgent:
    ...
    def mock_mlflow(self, mocker: MockerFixture):
        return mocker.patch("pamiq_curiosity_exp.agents.curiosity.adversarial.mlflow")
