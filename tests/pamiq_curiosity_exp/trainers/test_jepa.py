...
from pamiq_curiosity_exp.data import BufferName, DataKey
from pamiq_curiosity_exp.models import ModelName
from pamiq_curiosity_exp.models.jepa import create_image_jepa
from pamiq_curiosity_exp.trainers.jepa import (
    JEPATrainer,
...
class TestJEPATrainer:
    ...
    def models(self):
        ...
        return {
            ModelName.IMAGE_JEPA_CONTEXT_ENCODER: components[0],
            ModelName.IMAGE_JEPA_TARGET_ENCODER: components[1],
            ModelName.IMAGE_JEPA_PREDICTOR: components[2],
        }
    ...
    def trainer(self, partial_optimizer, collate_fn, mocker: MockerFixture):
        mocker.patch("pamiq_curiosity_exp.trainers.jepa.mlflow")
        return JEPATrainer(
            partial_optimizer,
